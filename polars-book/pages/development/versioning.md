...
If we decide to introduce a breaking change, the existing behavior is deprecated *if possible*. For
...
large part of the API. Such changes will not be warned for, but *will* be included in the changelog
...
1. Source page: https://docs.pola.rs/development/versioning
