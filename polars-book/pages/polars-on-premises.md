...
Polars On-Prem lets you run Polars clusters inside your own infrastructure, whether that's a managed Kubernetes service or bare metal. It is designed for teams that;
...
Self-Serve is the fastest way to get started. Get credentials from the Polars Cloud portal, deploy into your own infrastructure, and manage clusters and query profiling from there. Generous free tier, pay-as-you-go beyond that, no credit card required.
...
1. Source page: https://docs.pola.rs/polars-on-premises
