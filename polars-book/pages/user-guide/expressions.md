...
- Essentials:
  - [Basic operations](basic-operations/) – how to do basic operations on dataframe columns, like arithmetic calculations, comparisons, and other common, general-purpose operations
...
- How to work with specific types of data or data type namespaces:
  - [Strings](strings/) – how to work with strings and the namespace`str`
...
- Types of operations:
  - [Aggregation](aggregation/) – how to work with aggregating contexts like`group_by`
