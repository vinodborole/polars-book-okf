...
resource: https://docs.pola.rs/user-guide/lazy/execution
...
batches using *streaming* mode. To use streaming mode you simply pass the `engine="streaming"`
argument to `collect`
...
1. Source page: https://docs.pola.rs/user-guide/lazy/execution
