...
approx_n_unique()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11462-L11497)
...
- Consider the - `k`largest elements of the- `by`column(s) (instead of the- `k`smallest). This can be specified per column by passing a sequence of booleans.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6346-L6433)- cast(
...
- Raise if cast is invalid on rows after predicates are pushed down. If - `False`, invalid casts will produce null values.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9012-L9103)- 
clear(*n:*) DataFrame[int](https://docs.python.org/3/library/functions.html#int)= 0[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9105-L9161)
...
- Cheap deepcopy/clone. 
 ...
 - 
clone()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9163-L9196)
...
- Create an empty copy of the current DataFrame, with identical schema but no data. 
 ...
 - 
collect_schema()  Schema[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L1653-L1694)
- Get an ordered mapping of column names to their data type. - This is an alias for the - `schema`- See also - Notes - This method is included to facilitate writing code that is generic for both DataFrame and LazyFrame. - Examples - Determine the schema. - >>> df = pl.DataFrame( ... { ... "foo": [1, 2, 3], ... "bar": [6.0, 7.0, 8.0], ... "ham": ["a", "b", "c"], ... } ... ) >>> df.collect_schema() Schema({'foo': Int64, 'bar': Float64, 'ham': String}) - Access various properties of the schema using the - `Schema`object.- >>> schema = df.collect_schema() >>> schema["bar"] Float64 >>> schema.names() ['foo', 'bar', 'ham'] >>> schema.dtypes() [Int64, Float64, String] >>> schema.len() 3 
 - 
*property*columns*:*[list](https://docs.python.org/3/library/stdtypes.html#list)[[str](https://docs.python.org/3/library/stdtypes.html#str)][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L875-L912)
...
- Keyword arguments that are passed to - `numpy.corrcoef`.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12538-L12591)- 
count()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12881-L12902)
...
- Interpolation method used when calculating percentiles. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5891-L5990)- 
...
- `"json"`: Deserialize from JSON format (string).
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L497-L560)- drop(
...
- Validate that all column names exist in the current schema, and throw an exception if any do not. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8887-L8976)- 
drop_in_place(*name:*) Series[str](https://docs.python.org/3/library/stdtypes.html#str)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8978-L9010)
...
- Column name(s) for which NaN values are considered; if set to - `None`(default), use all columns (note that only floating-point columns can contain NaNs).
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6655-L6743)- drop_nulls(
- *subset: ColumnNameOrSelector | Collection[ColumnNameOrSelector] |*,- [None](https://docs.python.org/3/library/constants.html#None)= None
...
- Column name(s) for which null values are considered. If set to - `None`(default), use all columns.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6745-L6864)- 
*property*dtypes*:*[list](https://docs.python.org/3/library/stdtypes.html#list)[[DataType](../api/polars.datatypes.DataType.html#polars.datatypes.DataType)][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L927-L966)
...
- Consider null values as equal. 
 ...
 - [bool](https://docs.python.org/3/library/functions.html#bool)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6435-L6472)- 
estimated_size(*unit: SizeUnit = 'b'*)[int](https://docs.python.org/3/library/functions.html#int)|[float](https://docs.python.org/3/library/functions.html#float)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5048-L5091)
...
- Scale the returned size to the given unit. 
 ...
 - 
explode(*columns: ColumnNameOrSelector | Iterable[ColumnNameOrSelector], *more_columns: ColumnNameOrSelector, empty_as_null: bool = <object object>, keep_nulls: bool = True*) DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9467-L9541)
...
- DataFrame to vertically add. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8830-L8885)- 
fill_nan(*value: Expr |*) DataFrame[int](https://docs.python.org/3/library/functions.html#int)|[float](https://docs.python.org/3/library/functions.html#float)|[None](https://docs.python.org/3/library/constants.html#None)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9419-L9465)
...
- DataFrame with None values replaced by the filling strategy. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9315-L9417)- filter(
...
- Column filters; use - `name = value`to filter columns by the supplied value. Each constraint will behave the same as- `pl.col(name).eq(value)`, and be implicitly joined with the other filter conditions using- `&`.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5369-L5541)- 
*property*flags*:*[dict](https://docs.python.org/3/library/stdtypes.html#dict)[[str](https://docs.python.org/3/library/stdtypes.html#str),[dict](https://docs.python.org/3/library/stdtypes.html#dict)[[str](https://docs.python.org/3/library/stdtypes.html#str),[bool](https://docs.python.org/3/library/functions.html#bool)]][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L968-L978)
...
- Mapping from column names to column flags. 
 ...
 - 
fold(*operation: Callable[[Series, Series], Series]*) Series[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11602-L11693)
...
- If true when an index is out-of-bounds a null row will be generated instead of raising an error. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8576-L8632)- 
gather_every(*n:*,[int](https://docs.python.org/3/library/functions.html#int)*offset:*) DataFrame[int](https://docs.python.org/3/library/functions.html#int)= 0[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12270-L12306)
...
- Series (or arbitrary default value, if specified).
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9259-L9313)- 
get_column_index(*name:*)[str](https://docs.python.org/3/library/stdtypes.html#str)[int](https://docs.python.org/3/library/functions.html#int)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5992-L6011)
...
- Name of the column to find. 
 ...
 - 
get_columns()  [list](https://docs.python.org/3/library/stdtypes.html#list)[Series][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9198-L9251)
...
- `"string"`: Return the glimpse output as a string.
 ...
 - [str](https://docs.python.org/3/library/stdtypes.html#str)| DataFrame |- [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5715-L5889)- group_by(
...
- Object which can be used to perform aggregations. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L7139-L7288)- group_by_dynamic(
...
- “10i” # length 10 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L7448-L7767)- hash_rows( ) Series
...
- Random seed parameter. Defaults to - `seed`if not set.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12308-L12359)- 
head(*n:*) DataFrame[int](https://docs.python.org/3/library/functions.html#int)= 5[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6510-L6560)
...
- Number of rows to return. If a negative value is passed, return all rows except the last - `abs(n)`.
 ...
 - 
*property*height*:*[int](https://docs.python.org/3/library/functions.html#int)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L836-L851)
...
- Modify in place. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8736-L8777)- 
insert_column(*index:*,[int](https://docs.python.org/3/library/functions.html#int)*column: IntoExprColumn*) DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5297-L5367)
...
- `Series`or expression to insert.
 ...
 - 
interpolate()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12361-L12389)
- Interpolate intermediate values. The interpolation method is linear. - Nulls at the beginning and end of the series remain null. - Examples - >>> df = pl.DataFrame( ... { ... "foo": [1, None, 9, 10], ... "bar": [6, 7, 9, None], ... "baz": [1, None, None, 9], ... } ... ) >>> df.interpolate() shape: (4, 3) ┌──────┬──────┬──────────┐ │ foo ┆ bar ┆ baz │ │ --- ┆ --- ┆ --- │ │ f64 ┆ f64 ┆ f64 │ ╞══════╪══════╪══════════╡ │ 1.0 ┆ 6.0 ┆ 1.0 │ │ 5.0 ┆ 7.0 ┆ 3.666667 │ │ 9.0 ┆ 9.0 ┆ 6.333333 │ │ 10.0 ┆ null ┆ 9.0 │ └──────┴──────┴──────────┘ 
 - 
is_duplicated()  Series[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10286-L10321)
- Get a mask of all duplicated rows in this DataFrame. - Examples - >>> df = pl.DataFrame( ... { ... "a": [1, 2, 3, 1], ... "b": ["x", "y", "z", "x"], ... } ... ) >>> df.is_duplicated() shape: (4,) Series: '' [bool] [ true false false true ] - This mask can be used to visualize the duplicated lines like this: - >>> df.filter(df.is_duplicated()) shape: (2, 2) ┌─────┬─────┐ │ a ┆ b │ │ --- ┆ --- │ │ i64 ┆ str │ ╞═════╪═════╡ │ 1 ┆ x │ │ 1 ┆ x │ └─────┴─────┘ 
 - 
is_empty()  [bool](https://docs.python.org/3/library/functions.html#bool)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12391-L12403)
...
- Place null values last. When sorting by multiple columns, can be specified per column by passing a sequence of booleans. 
 ...
 - [bool](https://docs.python.org/3/library/functions.html#bool)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10240-L10284)- 
is_unique()  Series[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10323-L10358)
...
- Get the values of a single row, either by index or by predicate. 
 ...
 - 
iter_columns()  Iterator[Series][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12152-L12206)
...
- Materialises frame data as a key-indexed dictionary. 
 ...
 - [tuple](https://docs.python.org/3/library/stdtypes.html#tuple)[Any, ...]] | Iterator[- [dict](https://docs.python.org/3/library/stdtypes.html#dict)[- [str](https://docs.python.org/3/library/stdtypes.html#str), Any]]- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12077-L12150)- 
iter_slices(*n_rows:*) Iterator[DataFrame][int](https://docs.python.org/3/library/functions.html#int)= 10000[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12208-L12254)
...
- Which DataFrame row order to preserve, if any. Do not rely on any observed ordering without explicitly setting this parameter, as your code may break in a future release. Not specifying any ordering can improve performance. - **none**- *(Default)*No specific ordering is desired. The ordering might differ across Polars versions or even between different runs.- **left**- Preserves the order of the left DataFrame. - **right**- Preserves the order of the right DataFrame. - **left_right**- First preserves the order of the left DataFrame, then the right. - **right_left**- First preserves the order of the right DataFrame, then the left. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8226-L8470)- join_asof(
- *other: DataFrame*,
- ***,
...
- date - `2018-08-01`from- `population`is matched with- `2019-01-01`from- `gdp`.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L7871-L8224)- join_where(
- *other: DataFrame*,
...
- Suffix to append to columns with a duplicate name. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8472-L8574)- 
lazy()  LazyFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10360-L10395)
...
- LazyFrame
 ...
 - 
limit(*n:*) DataFrame[int](https://docs.python.org/3/library/functions.html#int)= 5[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6614-L6653)
...
- Keyword arguments to pass to the UDF. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6933-L7024)- map_rows(
...
- If your function is expensive and you don’t want it to be called more than once for a given input, consider applying an - `@lru_cache`decorator to it. If your data is suitable you may achieve- *significant*speedups.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8634-L8734)- match_to_schema(
...
- Forbid of upcast for float columns from the input to the respective column in - `schema`.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L13157-L13319)- 
max()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10735-L10760)
- Aggregate the columns of this DataFrame to their maximum value. - Examples - >>> df = pl.DataFrame( ... { ... "foo": [1, 2, 3], ... "bar": [6, 7, 8], ... "ham": ["a", "b", "c"], ... } ... ) >>> df.max() shape: (1, 3) ┌─────┬─────┬─────┐ │ foo ┆ bar ┆ ham │ │ --- ┆ --- ┆ --- │ │ i64 ┆ i64 ┆ str │ ╞═════╪═════╪═════╡ │ 3 ┆ 8 ┆ c │ └─────┴─────┴─────┘ 
 - 
max_horizontal()  Series[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10762-L10788)
...
- A Series named - `"max"`.
 ...
 - 
mean()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10908-L10934)
- Aggregate the columns of this DataFrame to their mean value. - Examples - >>> df = pl.DataFrame( ... { ... "foo": [1, 2, 3], ... "bar": [6, 7, 8], ... "ham": ["a", "b", "c"], ... "spam": [True, False, None], ... } ... ) >>> df.mean() shape: (1, 4) ┌─────┬─────┬──────┬──────┐ │ foo ┆ bar ┆ ham ┆ spam │ │ --- ┆ --- ┆ --- ┆ --- │ │ f64 ┆ f64 ┆ str ┆ f64 │ ╞═════╪═════╪══════╪══════╡ │ 2.0 ┆ 7.0 ┆ null ┆ 0.5 │ └─────┴─────┴──────┴──────┘ 
 - 
mean_horizontal(***,*ignore_nulls:*) Series[bool](https://docs.python.org/3/library/functions.html#bool)= True[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10936-L10970)
...
- A Series named - `"mean"`.
 ...
 - 
median()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11058-L11083)
...
- Name to give to the - `value`column. Defaults to “value”
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12904-L12945)- merge_sorted( ) DataFrame
- Take two sorted DataFrames and merge them by the sorted key. - The output of this operation will also be sorted. It is the callers responsibility that the frames are sorted in ascending order by the key, with null keys at the end, otherwise the order of the output will not make sense. - The schemas of both DataFrames must be equal. - Parameters:
- **other**
...
- If - `True`, the output is guaranteed to have left-biased ordering for equal keys: rows from the left frame appear before rows from the right frame when their keys are equal.
 ...
 - Notes - Unless - `maintain_order=True`, no guarantee is given over the output row order when the key is equal between the both dataframes.- The key must be sorted in ascending order. - Examples - >>> df0 = pl.DataFrame( ... {"name": ["steve", "elise", "bob"], "age": [42, 44, 18]} ... ).sort("age") >>> df0 shape: (3, 2) ┌───────┬─────┐ │ name ┆ age │ │ --- ┆ --- │ │ str ┆ i64 │ ╞═══════╪═════╡ │ bob ┆ 18 │ │ steve ┆ 42 │ │ elise ┆ 44 │ └───────┴─────┘ >>> df1 = pl.DataFrame( ... {"name": ["anna", "megan", "steve", "thomas"], "age": [21, 33, 42, 20]} ... ).sort("age") >>> df1 shape: (4, 2) ┌────────┬─────┐ │ name ┆ age │ │ --- ┆ --- │ │ str ┆ i64 │ ╞════════╪═════╡ │ thomas ┆ 20 │ │ anna ┆ 21 │ │ megan ┆ 33 │ │ steve ┆ 42 │ └────────┴─────┘ >>> df0.merge_sorted(df1, key="age") shape: (7, 2) ┌────────┬─────┐ │ name ┆ age │ │ --- ┆ --- │ │ str ┆ i64 │ ╞════════╪═════╡ │ bob ┆ 18 │ │ thomas ┆ 20 │ │ anna ┆ 21 │ │ megan ┆ 33 │ │ steve ┆ 42 │ │ steve ┆ 42 │ │ elise ┆ 44 │ └────────┴─────┘ 
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12593-L12684)- 
min()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10790-L10815)
- Aggregate the columns of this DataFrame to their minimum value. - Examples - >>> df = pl.DataFrame( ... { ... "foo": [1, 2, 3], ... "bar": [6, 7, 8], ... "ham": ["a", "b", "c"], ... } ... ) >>> df.min() shape: (1, 3) ┌─────┬─────┬─────┐ │ foo ┆ bar ┆ ham │ │ --- ┆ --- ┆ --- │ │ i64 ┆ i64 ┆ str │ ╞═════╪═════╪═════╡ │ 1 ┆ 6 ┆ a │ └─────┴─────┴─────┘ 
 - 
min_horizontal()  Series[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10817-L10843)
...
- A Series named - `"min"`.
 ...
 - 
n_chunks(*strategy: Literal['first', 'all'] = 'first'*)[int](https://docs.python.org/3/library/functions.html#int)|[list](https://docs.python.org/3/library/stdtypes.html#list)[[int](https://docs.python.org/3/library/functions.html#int)][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10699-L10733)
...
- One or more columns/expressions that define what to count; omit to return the count of unique rows. 
 ...
 - 
null_count()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11508-L11531)
...
- Return a dictionary instead of a list. The dictionary keys are tuples of the distinct group values that identify each group. 
 ...
 - [list](https://docs.python.org/3/library/stdtypes.html#list)[DataFrame] |- [dict](https://docs.python.org/3/library/stdtypes.html#dict)[- [tuple](https://docs.python.org/3/library/stdtypes.html#tuple)[Any, ...], DataFrame]- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10007-L10159)- pipe(
...
- Keyword arguments to pass to the UDF. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6866-L6931)- pivot(
...
- DataFrame
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9543-L9770)- 
*property*plot*: DataFramePlot*[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L671-L766)
...
- Change the opacity of the points in your scatter plot with - `.configure_point(opacity=.5)`.
 ...
 - 
product()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11085-L11116)
...
- Interpolation method. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11118-L11156)- 
rechunk()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11499-L11506)
...
- Column filters; use - `name = value`to filter columns using the supplied value. Each constraint behaves the same as- `pl.col(name).eq(value)`, and is implicitly joined with the other filter conditions using- `&`.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5543-L5686)- rename( ) DataFrame
...
- Validate that all column names exist in the current schema, and throw an exception if any do not. (Note that this parameter is a no-op when passing a function to - `mapping`).
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5241-L5295)- 
replace_column(*index:*,[int](https://docs.python.org/3/library/functions.html#int)*column: Series*) DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6013-L6051)
...
- Series that will replace the column. 
 ...
 - 
reverse()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5215-L5239)
...
- Object you can call - `.agg`on to aggregate by groups, the result of which will be sorted by- `index_column`(but note that if- `group_by`columns are passed, it will only be sorted within each group).
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L7290-L7446)- row( )
...
- tuple (default) or dictionary of row values
 ...
 - [tuple](https://docs.python.org/3/library/stdtypes.html#tuple)[Any, ...] |- [dict](https://docs.python.org/3/library/stdtypes.html#dict)[- [str](https://docs.python.org/3/library/stdtypes.html#str), Any]- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11713-L11826)- rows(
- ***,
...
- Materialises frame data as a key-indexed dictionary. 
 ...
 - [list](https://docs.python.org/3/library/stdtypes.html#list)[- [tuple](https://docs.python.org/3/library/stdtypes.html#tuple)[- [Any](https://docs.python.org/3/library/typing.html#typing.Any), ...]] |- [list](https://docs.python.org/3/library/stdtypes.html#list)[- [dict](https://docs.python.org/3/library/stdtypes.html#dict)[- [str](https://docs.python.org/3/library/stdtypes.html#str),- [Any](https://docs.python.org/3/library/typing.html#typing.Any)]]- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11834-L11897)- rows_by_key(
...
- Indicate that the key is unique; this will result in a 1:1 mapping from key to a single associated row. Note that if the key is - *not*actually unique the last row with the given key will be returned.
 ...
 - [dict](https://docs.python.org/3/library/stdtypes.html#dict)[Any, Any]- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11939-L12065)- sample(
...
- *shuffle:*,- [bool](https://docs.python.org/3/library/functions.html#bool)= False
...
- Seed for the random number generator. If set to None (default), a random seed is generated for each time the sample is called. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11533-L11600)- 
*property*schema*: Schema*[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L980-L997)
...
- Additional columns to select, specified as keyword arguments. The columns will be renamed to the keyword used. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10397-L10485)- select_seq(
- **exprs: IntoExpr | Iterable[IntoExpr]*,
- ***named_exprs: IntoExpr*,
...
- Additional columns to select, specified as keyword arguments. The columns will be renamed to the keyword used. 
 ...
 - See also 
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10487-L10516)- serialize( )
...
- `"json"`: Serialize to JSON format (string).
 ...
 - [bytes](https://docs.python.org/3/library/stdtypes.html#bytes)|- [str](https://docs.python.org/3/library/stdtypes.html#str)|- [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L2796-L2858)- set_sorted( ) DataFrame
...
- Whether the nulls are at the end. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12686-L12721)- 
*property*shape*:*[tuple](https://docs.python.org/3/library/stdtypes.html#tuple)[[int](https://docs.python.org/3/library/functions.html#int),[int](https://docs.python.org/3/library/functions.html#int)][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L823-L834)
- Get the shape of the DataFrame. - Examples - >>> df = pl.DataFrame({"foo": [1, 2, 3, 4, 5]}) >>> df.shape (5, 1) 
 - 
shift(*n:*,[int](https://docs.python.org/3/library/functions.html#int)= 1***,*fill_value: IntoExpr |*) DataFrame[None](https://docs.python.org/3/library/constants.html#None)= None[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10161-L10238)
...
- Strip trailing zeros from Decimal data type values. See - `Config.set_trim_decimal_zeros()`
 ...
 - [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12947-L13155)- 
shrink_to_fit(***,*in_place:*) DataFrame[bool](https://docs.python.org/3/library/functions.html#bool)= False[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12256-L12268)
...
- Length of the slice. If set to - `None`, all rows starting at the offset will be selected.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6474-L6508)- sort(
- *by: IntoExpr | Iterable[IntoExpr]*,
- **more_by: IntoExpr*,
...
- Whether the order should be maintained if elements are equal. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6053-L6163)- sql( ) DataFrame
...
- The SQL query executes in lazy mode before being collected and returned as a DataFrame. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6165-L6255)- 
std(*ddof:*) DataFrame[int](https://docs.python.org/3/library/functions.html#int)= 1[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10972-L11013)
...
- “Delta Degrees of Freedom”: the divisor used in the calculation is N - ddof, where N represents the number of elements. By default ddof is 1. 
 ...
 - 
*property*style*: GT*[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L768-L821)
- Create a Great Table for styling. - Warning - This functionality is currently considered - **unstable**. It may be changed at any point without it being considered a breaking change.- Polars does not implement styling logic itself, but instead defers to the Great Tables package. Please see the - [Great Tables reference](https://posit-dev.github.io/great-tables/reference/)for more information and documentation.- Examples - Import some styling helpers, and create example data: - >>> import polars.selectors as cs >>> from great_tables import loc, style >>> df = pl.DataFrame( ... { ... "site_id": [0, 1, 2], ... "measure_a": [5, 4, 6], ... "measure_b": [7, 3, 3], ... } ... ) - Emphasize the site_id as row names: - >>> df.style.tab_stub(rowname_col="site_id") - Fill the background for the highest measure_a value row: - >>> df.style.tab_style( ... style.fill("yellow"), ... loc.body(rows=pl.col("measure_a") == pl.col("measure_a").max()), ... ) - Put a spanner (high-level label) over measure columns: - >>> df.style.tab_spanner( ... "Measures", cs.starts_with("measure") ... ) - Format measure_b values to two decimal places: - >>> df.style.fmt_number("measure_b", decimals=2) 
 - 
sum()  DataFrame[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10845-L10870)
- Aggregate the columns of this DataFrame to their sum value. - Examples - >>> df = pl.DataFrame( ... { ... "foo": [1, 2, 3], ... "bar": [6, 7, 8], ... "ham": ["a", "b", "c"], ... } ... ) >>> df.sum() shape: (1, 3) ┌─────┬─────┬──────┐ │ foo ┆ bar ┆ ham │ │ --- ┆ --- ┆ --- │ │ i64 ┆ i64 ┆ str │ ╞═════╪═════╪══════╡ │ 6 ┆ 21 ┆ null │ └─────┴─────┴──────┘ 
 - 
sum_horizontal(***,*ignore_nulls:*) Series[bool](https://docs.python.org/3/library/functions.html#bool)= True[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10872-L10906)
...
- A Series named - `"sum"`.
 ...
 - 
tail(*n:*) DataFrame[int](https://docs.python.org/3/library/functions.html#int)= 5[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6562-L6612)
...
- Compatibility level to use when exporting Polars data structures. The default compatibility level is recommended for most users. Use - `pl.CompatLevel.oldest()`for the most compatible level.- `pl.CompatLevel.newest()`uses the highest supported compatibility level, but is considered unstable and may change without it being considered a breaking change.
 ...
 - [Table](https://arrow.apache.org/docs/python/generated/pyarrow.Table.html#pyarrow.Table)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L1746-L1804)- 
to_dict(***,*as_series:*)[bool](https://docs.python.org/3/library/functions.html#bool)= True[dict](https://docs.python.org/3/library/stdtypes.html#dict)[[str](https://docs.python.org/3/library/stdtypes.html#str), Series] |[dict](https://docs.python.org/3/library/stdtypes.html#dict)[[str](https://docs.python.org/3/library/stdtypes.html#str),[list](https://docs.python.org/3/library/stdtypes.html#list)[Any]][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L1817-L1910)
...
- True -> Values are Series False -> Values are List[Any] 
 ...
 - 
to_dicts()  [list](https://docs.python.org/3/library/stdtypes.html#list)[[dict](https://docs.python.org/3/library/stdtypes.html#dict)[[str](https://docs.python.org/3/library/stdtypes.html#str),[Any](https://docs.python.org/3/library/typing.html#typing.Any)]][[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L1912-L1929)
...
- If there are - `None`values in the series, a- `null`column is not generated
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11158-L11239)- 
to_init_repr(*n:*)[int](https://docs.python.org/3/library/functions.html#int)= 1000[str](https://docs.python.org/3/library/stdtypes.html#str)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L2726-L2781)
...
- The index order of the returned Jax array, either C-like (row-major) or Fortran-like (column-major). 
 ...
 - [dict](https://docs.python.org/3/library/stdtypes.html#dict)[- [str](https://docs.python.org/3/library/stdtypes.html#str), jax.Array]- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L2108-L2290)- to_numpy(
- ***,
- *order: IndexOrder = 'fortran'*,
...
function for the conversion to NumPy if necessary. Deprecated since version 0.20.28: Polars now uses its native engine by default for conversion to NumPy. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L1931-L2082)- to_pandas( )
...
- Returns:
 ...
 - [DataFrame](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html#pandas.DataFrame)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L2532-L2631)- 
to_series(*index:*) Series[int](https://docs.python.org/3/library/functions.html#int)= 0[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L2693-L2724)
...
- Location of selection. 
 ...
 - 
to_struct(*name:*) Series[str](https://docs.python.org/3/library/stdtypes.html#str)= ''[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12405-L12433)
...
- Unify the dtype of all returned tensors; this casts any column that is not of the required dtype before converting to Tensor. This includes the label column - *unless*the label is an expression (such as- `pl.col("label_column").cast(pl.Int16)`).
 ...
 - [dict](https://docs.python.org/3/library/stdtypes.html#dict)[- [str](https://docs.python.org/3/library/stdtypes.html#str), torch.Tensor] | PolarsDataset- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L2322-L2530)- top_k( ) DataFrame
...
- Consider the - `k`smallest elements of the- `by`column(s) (instead of the- `k`largest). This can be specified per column by passing a sequence of booleans.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L6257-L6344)- transpose(
- ***,
...
- DataFrame
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L5093-L5213)- unique(
...
- DataFrame with unique rows. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11241-L11384)- unnest(
...
- Rename output column names as combination of the struct column name, name separator and field name. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12435-L12536)- unpivot(
...
- Name to give to the - `value`column. Defaults to “value”
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9772-L9841)- unstack(
- ***,
...
- Fill values that don’t fit the new size with this value. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L9843-L9975)- update(
- *other: DataFrame*,
...
- Which order of rows from the inputs to preserve. See - `join()`- `join`this function preserves the left order by default.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L12723-L12879)- upsample(
...
- Result will be sorted by - `time_column`(but note that if- `group_by`columns are passed, it will only be sorted within each group).
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L7769-L7869)- 
var(*ddof:*) DataFrame[int](https://docs.python.org/3/library/functions.html#int)= 1[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L11015-L11056)
...
- Modify in place. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L8779-L8828)- 
*property*width*:*[int](https://docs.python.org/3/library/functions.html#int)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L853-L873)
...
- A new DataFrame with the columns added. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10518-L10651)- with_columns_seq(
- **exprs: IntoExpr | Iterable[IntoExpr]*,
- ***named_exprs: IntoExpr*,
...
- A new DataFrame with the columns added. 
 ...
 - See also 
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L10653-L10691)- with_row_count( ) DataFrame
...
- Start the row count at this offset. Default = 0 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L7098-L7137)- with_row_index( ) DataFrame
...
- Start the index at this offset. Cannot be negative. 
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L7026-L7096)- write_avro( )
...
- Schema name. Defaults to empty string. 
 ...
 - [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L3292-L3331)- 
write_clipboard(***,*separator:*,[str](https://docs.python.org/3/library/stdtypes.html#str)= '\t'***kwargs:*)[Any](https://docs.python.org/3/library/typing.html#typing.Any)[None](https://docs.python.org/3/library/constants.html#None)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L3271-L3290)
...
- Number of retries if accessing a cloud instance fails. - Deprecated since version 1.37.1: Pass {“max_retries”: n} via - `storage_options`instead.
 ...
 - [str](https://docs.python.org/3/library/stdtypes.html#str)|- [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L3065-L3269)- write_database(
...
- The number of rows affected, if the driver provides this information. Otherwise, returns -1. 
 ...
 - [int](https://docs.python.org/3/library/functions.html#int)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L4390-L4724)- write_delta(
...
- If the delta table doesn’t exist and MERGE action is triggered 
 ...
 - [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L4789-L5046)- write_excel(
...
- If you want unformatted output, you can use a selector to apply the “General” format to all columns (or all - *non-temporal*columns to preserve formatting of date/datetime columns), eg:- `column_formats={~cs.temporal(): "General"}`.
 ...
 - [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L3333-L3913)- write_iceberg(
...
- If ‘overwrite’, will replace table with new data. 
 ...
 - [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L4726-L4763)- write_ipc(
...
- Number of retries if accessing a cloud instance fails. - Deprecated since version 1.37.1: Pass {“max_retries”: n} via - `storage_options`instead.
 ...
 - [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L3945-L4056)- write_ipc_stream(
- *file:*,- [str](https://docs.python.org/3/library/stdtypes.html#str)| Path | IO[- [bytes](https://docs.python.org/3/library/stdtypes.html#bytes)] |- [None](https://docs.python.org/3/library/constants.html#None)
- ***,
- *compression: IpcCompression = 'uncompressed'*,
- *compat_level: CompatLevel |*,- [None](https://docs.python.org/3/library/constants.html#None)= None
...
- Use a specific compatibility level when exporting Polars’ internal data structures. 
 ...
 - [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L4076-L4133)- 
write_json(*file: IOBase |*)[str](https://docs.python.org/3/library/stdtypes.html#str)| Path |[None](https://docs.python.org/3/library/constants.html#None)= None[str](https://docs.python.org/3/library/stdtypes.html#str)|[None](https://docs.python.org/3/library/constants.html#None)[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L2866-L2910)
...
- Whether to check if the filename matches the compression settings. Will raise an error if compression is set to ‘uncompressed’ and the filename ends in one of (“.gz”, “.zst”, “.zstd”) or if compression != ‘uncompressed’ and the file uses an mismatched extension. Only applies if file is a path. - Warning - This functionality is considered - **unstable**. It may be changed at any point without it being considered a breaking change.
 ...
 - [str](https://docs.python.org/3/library/stdtypes.html#str)|- [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L2932-L3009)- write_parquet(
...
- Recursively create all the directories in the path. - Warning - This functionality is considered - **unstable**. It may be changed at any point without it being considered a breaking change.
 ...
 - [None](https://docs.python.org/3/library/constants.html#None)- [[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L4135-L4388)

[[source]](https://github.com/pola-rs/polars/blob/py-1.42.1/py-polars/src/../src/polars/dataframe/frame.py#L210-L13384)
