---
type: Web Page
title: Version 1.0 - Polars user guide
resource: https://docs.pola.rs/releases/upgrade/1
...
*replace* the time zone. The inconsistency has been fixed by always converting to the time zone
...
Calling `set_sorted` indicates that a column is sorted *individually*. Passing multiple columns
...
1. Source page: https://docs.pola.rs/releases/upgrade/1
